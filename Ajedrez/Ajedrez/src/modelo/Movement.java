...
public class Movement implements Serializable {
	...
	public static final int RISE_AND_KILL = 2;
	...
	public Movement(Coordenada origen, Coordenada destino, int tipoAccion, Pieza ficha, Pieza fichaGenerada, Pieza fichaPeon) {
